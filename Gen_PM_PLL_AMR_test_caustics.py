# copy from Gen_PM_PLL_AMR 12/12/25
# want to test if computing the exact hessian/caustic is not too computationally expensive
import os,pickle
...
class LensPart(): 
    def __init__(self,
                    ...
                    savedir_sim="lensing_test",reload=True # saving params
                    ):
